...
<li class="nav-item">
  <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseReport" aria-expanded="false" aria-controls="collapseMaterial">
    ...
    <div id="collapseReport" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="r_manpower.php"><i class="fas fa-fw fa-users mr-2"></i> Employee </a>
        <a class="collapse-item" href="r_mp.php"><i class="fas fa-fw fa-users mr-2"></i> Manpower </a>
        <a class="collapse-item" href="r_sb.php"><i class="fas fa-fw fa-users mr-2"></i> Sub-Contractor </a>
