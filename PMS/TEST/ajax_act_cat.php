...
if(isset($_POST["dept_id"]))
{
    ...
    $output .= "<option value=''>Select Activity Category</option>";
...
{
    $output = '';
    $query1 = "SELECT * FROM assigned_activity where Asgd_Act_Status=1 AND Asgd_Pct_Done<100 AND Act_Cat_Id='".$_POST["act_cat"]."' AND Flat_Id='".$_POST["flt_id"]."'";
    $query_run1 = mysqli_query($connection, $query1);
    // echo $query1
