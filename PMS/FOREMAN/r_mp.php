...
<div class="container-fluid">
    <div class="col-xl-12 col-lg-12">
        <h5 class="m-0 font-weight-bold text-primary mb-4">Manpower Supply Report</h5>
    ...
    <div class="card-body">
        ...
        if(isset($_POST['search'])){
            ...
            $dept_id=$_POST['dept_id']; $cat_id =$_POST['category_id']; 
            ...
            if($dept_id=='Select Department' && $max !=0){
                $query = "SELECT * FROM daily_entry as DE
                    ...
                    and asgn_mp.Asgn_MP_Status=1 and as_act.Asgd_Act_Status=1  and DE.DE_Pct_Done BETWEEN '$min' AND '$max'
            ...
            elseif($dept_id!='Select Department'  && $max==0){
                ...
                $query = "SELECT * FROM daily_entry as DE
                    LEFT JOIN asgn_mp ON asgn_mp.DE_Id = DE.DE_Id 
                    LEFT JOIN assigned_activity as as_act on as_act.Asgd_Act_Id = DE.Asgd_Act_Id 
                    WHERE asgn_mp.MP_Id='$mp' and DE.DE_Status=1 and as_act.Act_Id in (".$act_id.")
            ...
            elseif($dept_id!='Select Department'  && $max!=0){
                ...
                $query = "SELECT * FROM daily_entry as DE
                    LEFT JOIN asgn_mp ON asgn_mp.DE_Id = DE.DE_Id 
                    LEFT JOIN assigned_activity as as_act on as_act.Asgd_Act_Id = DE.Asgd_Act_Id 
                    WHERE asgn_mp.MP_Id='$mp' and DE.DE_Status=1 and DE.DE_Pct_Done BETWEEN '$min' AND '$max'
                    and asgn_mp.Asgn_MP_Status=1 and as_act.Asgd_Act_Status=1 and as_act.Act_Id in (".$act_id.")
                    and DE.`DE_Date_Entry` BETWEEN '".$from."' AND '".$to."' ORDER BY DE.DE_Date_Entry ASC";
                // echo $query;
            }// --
            else{
