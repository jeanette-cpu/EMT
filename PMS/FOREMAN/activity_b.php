...
<div class="col-xl-12 col-lg-12">
    ...
    <div class="card-body">
        ...
        while ($row_mp = mysqli_fetch_assoc($q_manpower_run))
        {
            ...
            echo '
            <tr>
                <form method="POST" action="codeb.php">
...
<div>
    ...
    <?php
        ...
        if(mysqli_num_rows($query_run2)>0)
        {
            ...
            $userStr = implode("', '", $ids);
            $query="SELECT * FROM daily_entry where DE_Status=1 and DE_Date_Entry='$Date' and User_Id='$user_id' and Asgd_Act_Id in ('$userStr')";
            $query_run = mysqli_query($connection, $query);
        }
        else
        { 
