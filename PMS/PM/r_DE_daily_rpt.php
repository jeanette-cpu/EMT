...
<div class="col-xl-12 col-lg-12">
    ...
    <table id="tbl1" class="table table-sm table-bordered" style="width:100%;  border-spacing: 0px;  border-collapse: collapse;">
        ...
        <tr>
            ...
            <td class="text-center" style="color:black">Remarks</td>
                <?php
                    if(isset($flt_ids))
                    {
                        $DE_q ="SELECT * FROM daily_entry LEFT JOIN assigned_activity on assigned_activity.Asgd_Act_Id = daily_entry.Asgd_Act_Id LEFT JOIN activity_category on activity_category.Act_Cat_Id = assigned_activity.Act_Cat_Id WHERE date(DE_Date_Entry)='$date_today' AND DE_Status=1 AND activity_category.Dept_Id='$dept_id' and Flat_Id in ('$flt_ids')";
        ...
        ?>
                ...
                WHERE DE.DE_Status=1 AND DE.User_Id in ('$user_ids') AND AS_W.Asgd_Worker_Status=1 AND AS_ACT.Asgd_Act_Status=1 AND EMP.EMP_STATUS=1 AND date(DE.DE_Date_Entry)='$date_today' AND AS_ACT.Flat_Id in ('$flt_ids') AND EMP.EMP_DESIGNATION LIKE '%elect%' ";
               ...
               //mp
                $q_mp_elect="SELECT SUM(Asgn_MP_Total) as mp_e FROM asgn_mp LEFT JOIN daily_entry as de on de.DE_Id=asgn_mp.DE_Id
                            ...
                            WHERE de.DE_Date_Entry='$date_today' AND as_act.Act_Cat_Id IN ('1','2','3','4','5') and de.User_Id in ('$user_ids') AND asgn_mp.Asgn_MP_Status=1 AND de.DE_Status=1";
                ...
                $q_sb_elect="SELECT SUM(Asgn_SB_Total) as sb_e FROM asgn_subcon 
                            ...
                            LEFT JOIN assigned_activity as as_act on as_act.Asgd_Act_Id=de.Asgd_Act_Id
                            WHERE de.DE_Date_Entry='$date_today' AND as_act.Act_Cat_Id IN ('1','2','3','4','5') and de.User_Id in ('$user_ids') AND asgn_subcon.Asgn_SB_Status=1 AND de.DE_Status=1";
                ...
                $q_mp_plumb="SELECT SUM(Asgn_MP_Total) as mp_p FROM asgn_mp LEFT JOIN daily_entry as de on de.DE_Id=asgn_mp.DE_Id
                            LEFT JOIN assigned_activity as as_act on as_act.Asgd_Act_Id=de.Asgd_Act_Id
                            WHERE de.DE_Date_Entry='$date_today' AND as_act.Act_Cat_Id IN ('6','7','8','9','10') and de.User_Id in ('$user_ids') AND asgn_mp.Asgn_MP_Status=1 AND de.DE_Status=1";
                ...
                $q_sb_plumb="SELECT SUM(Asgn_SB_Total) as sb_p FROM asgn_subcon 
                            LEFT JOIN daily_entry as de on de.DE_Id=asgn_subcon.DE_Id
                            LEFT JOIN assigned_activity as as_act on as_act.Asgd_Act_Id=de.Asgd_Act_Id
                            WHERE de.DE_Date_Entry='$date_today' AND as_act.Act_Cat_Id IN ('6','7','8','9','10') and de.User_Id in ('$user_ids') AND asgn_subcon.Asgn_SB_Status=1 AND de.DE_Status=1";
                ...
                $q_mp_hvc="SELECT SUM(Asgn_MP_Total) as mp_hvc FROM asgn_mp LEFT JOIN daily_entry as de on de.DE_Id=asgn_mp.DE_Id
                            LEFT JOIN assigned_activity as as_act on as_act.Asgd_Act_Id=de.Asgd_Act_Id
                            WHERE de.DE_Date_Entry='$date_today' AND as_act.Act_Cat_Id IN ('11','12','13','14','15') and de.User_Id in ('$user_ids') AND asgn_mp.Asgn_MP_Status=1 AND de.DE_Status=1";
                ...
                $q_sb_hvc="SELECT SUM(Asgn_SB_Total) as sb_hvc FROM asgn_subcon 
                            LEFT JOIN daily_entry as de on de.DE_Id=asgn_subcon.DE_Id
                            LEFT JOIN assigned_activity as as_act on as_act.Asgd_Act_Id=de.Asgd_Act_Id
                            WHERE de.DE_Date_Entry='$date_today' AND as_act.Act_Cat_Id IN ('11','12','13','14','15') and de.User_Id in ('$user_ids') AND asgn_subcon.Asgn_SB_Status=1 AND de.DE_Status=1";
                ...
                and de.DE_Status=1 and de.User_Id in ('$user_ids')"; 
