          ...
          <td class="btn btn-group">
            <form action="r_chart.php" method="POST">
              ...
              <button type="submit" name ="reportBtn" class="btn btn-primary mr-2">
                Project <i class="fa fa-line-chart" aria-hidden="true"></i>
              </button>
            </form>
            <!-- inventory -->
            <form action="r_mat_dashboard.php" method="POST">
              <input type="hidden" name="prj_id" value="<?php echo $row['Prj_Id'];?>">
              <button type="submit" name="prjMatBtn" class="btn btn-success">
                Inventory <i class="fa fa-archive" aria-hidden="true"></i>
              </button>
            </form>
          </td>
        </tr>
