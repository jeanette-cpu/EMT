...
<div class="container-fluid">
    <div class="col-xl-12 col-lg-12">
        <h5 class="m-0 font-weight-bold text-primary mb-4">Subcontractor Total</h5>
        <form action="m_sb.php" method="POST">
            <div class="row">
                <div class="col-4">
                    <label for="">Subcontractor Companies</label>
                        <select name="sb_opt" id="sb_opt" class="form-control selectpicker" data-live-search="true"></select>
                </div>
                <div class="col-3">
    ...
    <div class="card-body">
        ...
        if(isset($_POST['search']) or isset($_GET['id'])){
            ...
            $query = "SELECT * FROM daily_entry as DE LEFT JOIN asgn_subcon ON asgn_subcon.DE_Id = DE.DE_Id 
                    LEFT JOIN assigned_activity as as_act on as_act.Asgd_Act_Id = DE.Asgd_Act_Id 
                    WHERE asgn_subcon.SB_Id='$sb' and DE.DE_Status=1 
                    and asgn_subcon.Asgn_SB_Status=1 and as_act.Asgd_Act_Status=1  AND asgn_subcon.Asgn_SB_Total is not null
            ...
            $query_run = mysqli_query($connection, $query);
                if(mysqli_num_rows($query_run)>0)
                {
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['Asgn_SB_Total']; $mp_total = $mp_total+$row['Asgn_SB_Total']?></td>
                        <td class="d-none"><?php echo $row['Asgn_SB_Id'] ?></td>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
          <!-- MODAL TITLE -->
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-child" aria-hidden="true"></i> Subcontractor</h5>
      ...
      <div class="modal-body">
        <form action="code.php" method="POST">
            <div class="form-group">
                <input type="hidden" name="Asgn_SB_Id" id="Asgn_MP_Id" >
                <label>Total: </label>
                <input type="number" name="Asgn_SB_Total" id="Asgn_MP_Total" class="form-control">
                
                <input type="hidden" name="sb_id" value="<?php echo $sb?>">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="sbTotal" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Save</button>
      </div>
      </form>
    </div>
  </div>
