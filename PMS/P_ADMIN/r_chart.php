    ...
    <div class="col-xl-12 col-lg-12">
        <div class="row">
            ...
            <div class="col-3" >
                ...
                <select name="activities" id="act_opt" class="form-control tbl"></select>
            </div>
        </div>
        <!-- AJAX TABLE  -->
        <div class="card-body">
...
$(document).ready(function () {
    ...
    $(document).on('change','#cat_opt', function(){
        var cat_id = $(this).val();
        $.ajax({
            url: 'ajax_act_cat.php',
            method: 'POST',
