            ...
            <div class="table-responsive">
                ...
                if(isset($_POST['search'])){
                    ...
                    $q_trans = "SELECT * FROM transaction as t
                            LEFT JOIN account as acc on acc.Account_Id =t.Account_Id
                            LEFT JOIN bank as b on b.Bank_Id =acc.Bank_Id
                            WHERE t.Transaction_Status=1 AND t.Transaction_Cancel_Status=0 ORDER BY t.Transaction_Date ASC LIMIT 500";
                }
                    $q_trans_run=mysqli_query($connection,$q_trans);
                    if(mysqli_num_rows($q_trans_run)>0){
                        $balance=0; $total_rAmt=0; $total_pAmt=0; $firstRow=true;
                        while($row=mysqli_fetch_assoc($q_trans_run)){
                            ...
                            if($firstRow){
                                ...
                                $firstRow=false;
                                echo '<tr id="fRow">
                                        <td class="d-none"></td> <!-- 0-->
                                        <td class="d-none"></td> <!-- 1-->
                                        <td></td> <!-- 2-->
                                        <td></td> <!-- 3-->
                                        <td></td> <!-- 4-->
                                        <td></td> <!-- 5-->
                                        ...
                                        <td></td> <!-- 7-->
                                        <td></td> <!-- 8-->
                                        <td><span class="float-right">'.$opBalOutput.'</span></td> <!-- 9-->
                                        <td></td> <!-- 10-->
                                        <td></td> <!-- 11-->
                                        <td></td> <!-- 12-->
                                        <td class="d-none"></td> <!-- 13-->
                                        <td class="d-none"></td> <!-- 14-->
                                        <td class="d-none"></td> <!-- 15 -->
                                        <td class="d-none"></td> <!-- 16 -->
                                        <td class="d-none"></td> <!-- 17 -->
                                        <td class="d-none"></td> <!-- 18 -->
                                        <td class="btn-group text-center"> </td>
                                        <td></td>
                                    </tr>';
                            }
