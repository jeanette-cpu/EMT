        ...
        <div class="card-body">
            ...
            <input type="hidden" name="username" pattern="{5,15}" value="<?php echo $_SESSION['USERNAME']; ?>">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        <div class="input-group">
                            <input type="password" name="newp" pattern="{5,15}" class="form-control" id="newp" required>    
                            <div class="input-group-append">  
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        <div class="input-group">
                            <input type="password" name="confirmp" pattern="{5,15}" class="form-control" id="cp" required>
                            <div class="input-group-append">  
