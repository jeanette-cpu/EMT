  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="code.php" method="POST">
            ...
            <div class="form-group">
                <label>Usertype</label>
                    <select name="usertype" id="usertype" class="form-control" required>
                        ...
                        <option value="purchase">Purchase Admin</option>
                    </select>
            </div>
        <!-- END FORM -->
      </div>
      <div class="modal-footer">
        ...
        <button type="submit" name="addPurchase" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Save</button>
      </div>
      </form>
    </div>
  </div>
        ...
        <h5 class="modal-title" id="exampleModalLabel">Edit User Details</h5>
            ...
            <form action="code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label> Email </label>
                        <input type="text" name="edit_email" id="user_email" class="form-control" maxlength="40">
                    </div>
                    <div class="form-group">
                        <label> Password </label>
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <?php
                $query = "SELECT * FROM users WHERE USER_STATUS =1 AND USERTYPE='purchase'";
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td class="btn btn-group">
                                <!-- EDIT -->
                                <button type="button" class="btn btn-success editUsers" data-toggle="modal" data-target="#EditUsersModal">
