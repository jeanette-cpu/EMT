            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-4">
                        ...
                        <input type="text" name="emat_code" id="mat_code" class="form-control" required>
                    </div>
                    <div class="col-8">
                        <label>Material Desc</label>
                        <input type="text" name="emat_desc" id="mat_desc" class="form-control" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-6">
                        ...
                        <select name="emat_unit" id="mat_unit" class="form-control" required>
                            <option value="">Select Unit</option>
                                <option value="m">m</option>
                                <option value="No">No</option>
                                <option value="Roll">Roll</option>
