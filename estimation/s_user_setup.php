...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <?php
                $query = "SELECT * FROM users WHERE USER_STATUS=1 AND USERTYPE='estimation'";
        ...
        <div class="form-row">
            ...
            <div class="col-6 d-none">
                <div class="form-group">
                    ...
                    <input type="hidden" name="usertype" value="estimation">
            ...
            <form action="code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group d-none" >
                        ...
                        <input type="text" name="edit_type" value="estimation">
