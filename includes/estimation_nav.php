  ...
  <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseSetup" aria-expanded="false" aria-controls="collapseMaterial">
    ...
    <div id="collapseSetup" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="s_project.php"><i class="fas fa-fw fa-home mr-2 "></i>Projects</a>
        <a class="collapse-item d-none" href="s_project_sys.php"><i class="fas fa-fw fa-cogs mr-2"></i>Project Systems</a>
        <a class="collapse-item" href=s_client.php><i class="fas fa-fw fa-users mr-2"></i>Clients</a>
        <a class="collapse-item" href=s_main_contractor.php><i class="fas fa-fw fa-bank mr-2"></i>Main Contractor</a>
        <a class="collapse-item" href=s_consultant.php><i class="fas fa-fw fa-pen mr-2"></i>Consultant</a>
        <a class="collapse-item" href=s_target.php><i class="fas fa-fw fa-bullseye mr-2"></i>Target Project</a>
        <a class="collapse-item" href=s_user_setup.php><i class="fas fa-fw fa-users mr-2"></i>Users</a>
      </div>
    </div>
</li>
<li class="nav-item">
  <a class="nav-link" href="est_project.php">
  <i class="fas fa-fw fa-file-text"> </i>
      <span>Estimations</span></a>
</li>
<!-- Nav Item LOGOUT -->
<li class="nav-item">
